...
ALLOWED_HOSTS = ['hermandai.up.railway.app', '127.0.0.1', 'tbd-platform-production.up.railway.app/', 'localhost']
CSRF_TRUSTED_ORIGINS = ['https://hermandai.up.railway.app', 'https://tbd-platform-production.up.railway.app']
